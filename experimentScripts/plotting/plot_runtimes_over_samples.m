function [avg_runtimes_inct,std_runtimes_inct,avg_runtimes_batch,std_runtimes_batch,avg_runtimes_lssvm,std_runtimes_lssvm]=plot_runtimes_over_samples(samples,path_to_results,title_text)
bs=100;
avg_runtimes_inct=[];
std_runtimes_inct=[];
...
for i=1:length(samples)
    ...
    fprintf('Exists? %s, %s\n',path_to_lssvm,exist(path_to_lssvm, 'file'))
