...
for run=1:runs
    highMassPhysicsExperimenttraining(experimentName,run,shuffleSeedValidation,validationOffset,fidTrain,fidTest,offsetTrain,offsetTest,outputPath,codePath,numSelectSamples,batchSize,dataLimit,1,1,[params.reguBeta],[params.reguAlpha],[params.kernelSigma]);
end
